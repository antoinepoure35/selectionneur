    const classes = {
		...
		'5A': ["A.Mona","B.Clément","B.Clémence","C.Edouard","C.Corentin","C.Pierre","C.Nolan","D.Augustin","D.Anouk","E.Adrien","F.Corentin","G.Alix","G.Malo","G.Thomas","G.Cassie","H.Julie","J.Roxane","J.Hugo","J.Maxence","L.Ayden","M.Lucie","M.Raphaël","O.Natasha","P.Elouan","P.Mathéo","R.Kimi","S.Jules","S.Louann","S.Tylio","V.Alexis"],
		'5B': ["B.Chloé", "B.Oscar", "B.Coralie", "C.Marianne", "C.Paola", "C.Thibaud", "D.Alexis", "F.Lya", "G.Klervie", "G.Antone", "G.Alexandre", "H.Cassandre", "J.Laura", "J.Naya", "K.Florian", "L.Juliette", "L.Léo", "L.Mathéo", "L.Lorraine", "M.Jules", "C.Clément", "N.Malo", "P.Apolline", "R.Clementine", "R.Ziad", "A.Angèle", "J.Jeanne", "T.Julie", "C.Charline"],
		'5C': ["B.Jade", "B.Manon", "B.Camille", "B.Kenza", "D.Inès", "D.Lisa", "D.Mila", "E.Erwan", "E.Simon", "G.Raphaëlle", "G.Arthur", "G.Gabriel", "L.Tiana", "L.Baptiste", "L.Nolwenn", "L.Bertille", "L.Martin", "L.Maxence", "L.Baptiste", "L.Adam", "L.Thomas", "L.Tom", "M.Julian", "M.Evan", "M.Samuel", "M.Elouen", "M.Ombeline", "P.Maxence", "R.Clémence"],
		...
		'4B': ["A.Héloïse", "B.Youenn", "B.Malou", "B.Lise", "B.Sami", "B.Anaé", "B.Noa", "C.Jeanne", "C.Lyna", "C.Alice", "C.Glenn", "D.Colin", "E.Dorian", "E.Clément", "G.Joan", "H.Kenji", "J.Maïwen", "J.Aaron", "L.Louis", "L.Simon", "M.Charlie", "N.Jocelin", "O.Hugo", "P.Alexis", "Q.Nina", "R.Maël", "R.Thomas", "S.Chloé", "V.Anna"],
